# PlantPAx Orchestration Ansible Developer WSL configuration
...
- Windows 10 or 11
- WSL 2
- Either the default OS, Ubuntu 22.04.4 LTS, or Fedora WSL, freely available from the Microsoft Stor Application.

### Install WSL OS of your choice

#### Default Ubuntu installation

Simply open a Windows command prompt or PowerShell, and enter "wsl --install".
Once theh installation is complete, reboot to activate WSL.

#### Fedora WSL installation

Open a Windows command prompt or PowerShell, and enter "wsl --install --no-distribution".
...
wsl_ansible_setup.bash is designed to detect whether it is running on Fedora or Ubuntu and perform the necessary steps to configure the following:
...
```
cd existing_repo
git remote add origin https://ragitlabegl4.ra.rockwell.com/lfs/plantpax/systemorchestration/plantpax-orchestration-developer-wsl-configuration.git
git branch -M main
...
- [ ] [Set up project integrations](https://ragitlabegl4.ra.rockwell.com/lfs/plantpax/systemorchestration/plantpax-orchestration-developer-wsl-configuration/-/settings/integrations)
